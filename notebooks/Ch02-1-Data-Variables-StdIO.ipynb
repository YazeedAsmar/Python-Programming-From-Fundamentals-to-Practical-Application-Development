  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/YazeedAsmar/Python-Programming-From-Fundamentals-to-Practical-Application-Development/blob/main/notebooks/Ch02-1-Data-Variables-StdIO.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
      ...
      "source": [
        ...
        "\n",
        "## External Resources\n",
        "- YouTube Podcast - [https://youtu.be/tUiTcTFewhI](https://youtu.be/tUiTcTFewhI)\n",
        "- YouTube Video - [https://youtu.be/K2lXDou5w-E](https://youtu.be/K2lXDou5w-E)\n",
        "- NotebookLM learning resources - [https://notebooklm.google.com/notebook/f79f7645-90df-4663-8276-8f78a1b54017](https://notebooklm.google.com/notebook/f79f7645-90df-4663-8276-8f78a1b54017)\n",
        "\n",
        "\n",
    ...
    },
    {
      ...
      "outputs": [],
      "source": [
        "print('hello \\r there... how are you?')"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        "print('What\\'s up Shaq O\\'Neal?')"
      ],
      "metadata": {
        "id": "DPqtOpZTUHvm"
      },
